...
module GuideAsStrcmp :
  functor (GuideDSE_v:TypeGuideDSE.TypeGuideDSE) ->
  ...
  with type trace_t = TraceDSE_v.trace_t
   ...
   and type score_input_t = GuideDSE_v(TraceDSE_v)(HistoryDSE_v).score_input_t
   and type score_t = GuideDSE_v(TraceDSE_v)(HistoryDSE_v).score_t

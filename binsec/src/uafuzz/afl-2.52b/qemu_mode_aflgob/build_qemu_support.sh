...
cp -f "${CPU_TARGET}-linux-user/qemu-${CPU_TARGET}" "../../afl-qemu-trace-aflgob" || exit 1

cd ..
ls -l ../afl-qemu-trace-aflgob || exit 1

echo "[+] Successfully created '../afl-qemu-trace-aflgob'."

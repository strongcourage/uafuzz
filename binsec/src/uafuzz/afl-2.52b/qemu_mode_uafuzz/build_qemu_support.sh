...
cp -f "${CPU_TARGET}-linux-user/qemu-${CPU_TARGET}" "../../afl-qemu-trace-uafuzz" || exit 1

cd ..
ls -l ../afl-qemu-trace-uafuzz || exit 1

echo "[+] Successfully created '../afl-qemu-trace-uafuzz'."
